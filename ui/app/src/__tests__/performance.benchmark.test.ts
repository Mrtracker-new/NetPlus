    ...
    it("Antimeridian Seam Boundary: 5,000 endpoints at +179.9° and 5,000 endpoints at -179.9°", () => {
      ...
      for (let i = 0; i < 5000; i++) {
        ...
        eastHosts.push({
          ...
          geography: {
            precision: "country",
            coordinates: { latitude: -16.0, longitude: 179.9, scope: "region" },
            confidence: "medium",
            source: "local_database",
            explanation: "Benchmark test host",
          },
          ...
          geographicPrecision: "country",
          identityPrecision: "asn",
          infrastructure: { type: "unicast" },
          resolutionReason: "Benchmark test host",
          hostnames: [],
          bytes: 1000,
          deltaBytes: 0,
          flows: 1,
      ...
      const greenwichHost: EnrichedHost = {
        ...
        geography: {
          precision: "city",
          coordinates: { latitude: 51.5, longitude: 0.0, scope: "city" },
          confidence: "medium",
          source: "local_database",
          explanation: "Benchmark test host",
        },
